...
- [ ] **Phase 7: Custom Agents + Session History** - Agent CRUD builder and past session browsing/resumption
- [ ] **Phase 8: Project Management + Task Kanban** - Project CRUD, agent assignment, drag-and-drop task board
